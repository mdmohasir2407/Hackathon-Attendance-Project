...
$stmt = $pdo->prepare("
    SELECT u.email, u.profile_pic, s.roll_number, s.first_name, s.last_name, s.phone 
    FROM users u 
        ...
        <div class="col-md-4 mb-4">
            <div class="card premium-glass-card border-0 shadow-sm text-center">
                <div class="card-body py-5">
                    ...
                    <p class="text-muted mb-3"><i class="bi bi-mortarboard-fill me-2 text-primary"></i>Student (<?php echo htmlspecialchars($user_data['roll_number']); ?>)</p>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control premium-input bg-light" value="<?php echo htmlspecialchars($user_data['roll_number']); ?>" readonly>
                                <small class="text-muted">Contact admin to change roll number.</small>
                            </div>
                        </div>
