...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error_msg) && !empty($first_name)) {
        try {
            $stmt = $pdo->prepare("UPDATE teachers SET first_name = ?, last_name = ?, phone = ? WHERE id = ?");
...
$stmt = $pdo->prepare("
    SELECT u.email, u.profile_pic, t.first_name, t.last_name, t.phone, d.name as department_name
    FROM users u 
        ...
        <div class="col-md-4 mb-4">
            <div class="card premium-glass-card border-0 shadow-sm text-center">
                <div class="card-body py-5">
                    ...
                    <p class="text-muted mb-3"><i class="bi bi-person-video3 me-2 text-primary"></i>Teacher</p>
                    <p class="text-muted small mb-1"><i class="bi bi-building me-2"></i><?php echo htmlspecialchars($user_data['department_name'] ?? 'No Department'); ?></p>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control premium-input bg-light" value="<?php echo htmlspecialchars($user_data['department_name'] ?? 'None'); ?>" readonly>
