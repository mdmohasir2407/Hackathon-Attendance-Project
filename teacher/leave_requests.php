...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold mb-0">Student Leave Requests</h2>
</div>
...
<div class="card-modern">
    <div class="table-responsive">
        <table class="table table-modern">
            ...
            <tbody>
                <?php
                // Fetch leave requests for students enrolled in classes this teacher teaches
                $stmt = $pdo->prepare("
                    SELECT DISTINCT lf.*, s.first_name, s.last_name, s.roll_number
                    FROM leave_forms lf
